  ...
  projectsData.forEach((p, idx) => {
    ...
    card.innerHTML = `
            ...
            <div class="project-meta">
                <span class="team-size">👥 ${teamCount} Member${
      teamCount === 1 ? "" : "s"
    }</span>
  ...
  cvViewer.innerHTML = `
        <div style="text-align: center; padding: 12px;">
            ...
            <div style="margin-top: 12px;">
                <a href="${cvPath}" download style="display: inline-block; padding: 10px 14px; background: linear-gradient(90deg, #6366f1, #ec4899); color: white; border-radius: 8px; text-decoration: none; font-weight: 600;">📥 Download CV</a>
            </div>
        </div>
    `;
